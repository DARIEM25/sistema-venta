<?= $this->extend('admin/Administrador');?>
<?= $this->section('contenido');?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0 font-weight-bold">Hola, <?= session('nombre'); ?> <?= session('apellido'); ?></h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between">
                      <h4 class="card-title mb-3">Tendencia del análisis de venta</h4>
                    </div>
                    <div class="mt-2">
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?= base_url();?>public/Dashboard/images/faces/face30.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?= base_url();?>public/Dashboard/images/faces/face31.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?= base_url();?>public/Dashboard/images/faces/face32.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?= base_url();?>public/Dashboard/images/faces/face33.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex">
                                <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?= base_url();?>public/Dashboard/images/faces/face34.png" alt="profile image">
                                <div>
                                  <div> Company</div>
                                  <div class="font-weight-bold  mt-1">volkswagen</div>
                                </div>
